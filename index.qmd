...
## Auteur.ices, affiliations and contributions {.smaller} 
...
Suzanne Bonamour `suzanne.bonamour@lpo.fr` ou Adrien Chaigne `adrien.chaigne@lpo.fr`

::: {.logo-line style="display:flex; justify-content:center; align-items:center; gap:10px; margin-top:20px;"}
<img src="lpo_logo.jpg" width="65">
<img src="reserve_logo.png" width="130">
<img src="MNHN-logo.jpg" width="65">
<img src="logo_CESCO.png" width="210">
<img src="Logo-Prefet-de-la-Region-Nouvelle-Aquitaine.png" width="140">
<img src="Logo-FSE-UE-Region-Nouvelle-Aquitaine.png" width="160">
<img src="LIENSs_transp1-e1485208828412.png" width="80">
<img src="fonds-vert_logo.png" width="120">
:::
...
tags$iframe(
  src = "zone_critique_hotspot_map_final.html",
  width = "100%",
  height = "400px"
)
```
...
!!!!!! testé mais sans effets detecté : changement d'utilisation de l'espace quand fermeture de la chasse, avec zone de danger et zone de proximité
