...
-   de façon plus fine (@fig-UDMap_roosting_ZOOM) sur les zones spécifiques A, B, C, D et E (voir @fig-zone_map, sur des grilles de 10m x 10m).
...
-   soit de façon plus fine (@fig-UDMap_foraging_ZOOM) sur les zones spécifiques A, B, C, D et E (voir @fig-zone_map, sur des grilles de 10m x 10m). Les zones d'alimentation sont identifiées à l'aide de la fonction [kernelUD]{style="font-family: 'Courier';"} du package "adehabitatHR" [Calenge (2006)](#calenge2006).
...
::: {#fig-UDMap_roosting_ECE_wNO_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ECE_wNO_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ECE_wNO_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ECE_wNO_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_D.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ECE_wNO_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_E.html",
  width = "100%",
  height = "400px"
)
```
...
Alimentation zone A en fonction des vents de Nord-Ouest
:::
...
Alimentation zone B en fonction des vents de Nord-Ouest
:::
...
Alimentation zone C en fonction des vents de Nord-Ouest
:::
...
Alimentation zone D en fonction des vents de Nord-Ouest
:::
...
Alimentation zone E en fonction des vents de Nord-Ouest
:::
::::::::
