...
La zone d'étude est divisée en trois zones distinctes A, B et C
:::
...
Zones de repos : principaux reposoirs en rose foncé (50% des points GPS), zones secondaires de repos en rose clair (95% des points GPS) 
:::
...
## Reposoirs en fonction de l'age
...
Zones de repos en fonction du sexe : reposoirs femelle en rose (pricipaux reposoirs en rose foncé, 50% des points GPS ; reposoirs secondaires en rose clair, 95% des points GPS), reposoirs mâle en jaune (pricipaux reposoirs en jaune foncé, 50% des points GPS ; reposoirs secondaires en jaune clair, 95% des points GPS)
:::
...
Zone d'alimentation zone A en fonction du jour et de la nuit
:::
...
Zone d'alimentation zone B en fonction du jour et de la nuit
:::
...
Zone d'alimentation zone C en fonction du jour et de la nuit
:::
::::::
...
temps passé dans la r&serve : Le temps passé dans la réserve est estimé comme le nombre de point GPS observés dans et hors réserve pour chaque individu. Chaque point représente 5 min de temps.
