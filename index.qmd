...
La [règle de Silverman](https://fr.wikipedia.org/wiki/Estimation_par_noyau) est utilisé pour estimer un smoothing paramètre h/2 à adapté à chaque échantillon du jeu de données et permettant des analyses de grain très fin.
