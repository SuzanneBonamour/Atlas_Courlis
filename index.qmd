...
Aire (en m²) du domaine vital des individus en fonction de leur age ou de leur sexe.
...
Aire du domaine vital des individus à 95% et 50% en fonction de leur age ou de leur sexe.
:::
...
La distance entre la zone d'alimentation et de repos a été estimé comme la distance entre les paires de centroïds géographiques individuels des zones d'alimetation et de repos à chaque cycle de marais (@fig-distance_roost_forag_allvar_plot).
...
La fidélité inter-annuelle aux espaces a également été estimé. Néanmoins, trop de variabilité inter-individuelle sont resortie pour voir tirer des conclusions de ces analyses.
...
L'utilisation de l'espace pour les comportements de repos et d'alimentation pendant les jours avec évènements extrêmes detectées sont comparés aux jours 7 jours avant les évènements extrêmes et considéré comme "normaux".

Les vents de Nord-Ouest semblent de pas avoir d'effet sur les comportements de repos ni d'alimentation, tout comme les vents forts sur les reportements de repos. 

Seuls les resultats montrant l'influence des vents forts sur les comportements d'alimentation sont présentés ici.
...
### Comportement d'évitement de la chasse à pied et à la tonnes
...
Les données disponibles pour la chasse à pied se restreinge à la zone DPM. Les analyses sont donc faites uniquement dans la zone C autour de la zone principale de présence des chasseurs.

Egalement, afin de limiter les effets de variation saisonnière sur l'utilisation de l'espace, le jeu de données est restrait autour de la fermeture de la chasse : 15 dernier jour de la période de chasse (in), 15 premier jour après la fermeture de la chasse (out).
...
Aucun effet n'a pu être visieullement détecté sur l'utilisation de l'espace pour le repos et l'alimentation.
...
Notamment, les données sur les chasses (et la pêche) manque de précisions et d'ampleur temporelles et géopgraphiques. 

Ce travail constitue une étape crucial pour obtenir une image générale des comportements de Courlis cenrdrée dans la région, mais cela ne pourra que bénéficier de plus d'années de suivi et de plus d'individus équipé, en parallèle d'une récolte plus fine, lorsque cela est possible, des données environnementales et des pressions anthropiques.
