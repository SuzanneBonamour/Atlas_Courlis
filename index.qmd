...
Créée en 1985, la Réserve naturelle nationale de Moëze-Oléron (RNNMO, @fig-Photo_intro) s’étend sur près de 6 800 hectares entre le continent charentais et l’île d’Oléron. Gérée par la Ligue pour la Protection des Oiseaux (LPO-France), elle abrite chaque année environ 100 000 oiseaux d’eau, dont de nombreux limicoles migrateurs et hivernants. 
...
# ** Périodes d'émission des balises GPS**
...
::: {#fig-baguage}
```{r, out.height = "300px", out.width= "500px"}
#| echo: false
...
Comportement d'alimentation (Pierre-Marie Epiney)
:::
