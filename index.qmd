...
::: {#fig-UDMap_roosting_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_D.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_E.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_tides_high_type_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_tides_high_type_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_tides_high_type_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_tides_high_type_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_tides_high_type_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_tides_high_type_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_tides_high_type_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_tides_high_type_D.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_tides_high_type_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_tides_high_type_E.html",
  width = "100%",
  height = "400px"
)
```
