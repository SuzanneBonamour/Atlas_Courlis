...
<p style="font-size: 0.8em !important; color: lightgray !important; text-align: right !important; margin-top: 0 !important;">
...
Courlis cendré (a), Equipement GPS d'un courlis cendré (b), Survol drone de la réserve naturelle nationale de Moëze-Oléron côté continent (c, crédit photos : Armel Deniau, Loic Jomat, Romain Beaubert).
:::
...
-   à partir des données de l'ensemble des individus via la délimitation de zone "hotspot" [Bakker et al. (2021)](#bakker2021) et de façon global sur toute la zone d'études (sur des grilles de 100m x 100m, @fig-UDMap_roosting_hotspot_from1id)
-   de façon plus fine sur les zones spécifiques A, B, C, D et E (sur des grilles de 10m x 10m, @fig-UDMap_roosting_ZOOM_A, @fig-UDMap_roosting_ZOOM_B, @fig-UDMap_roosting_ZOOM_C, @fig-UDMap_roosting_ZOOM_D, @fig-UDMap_roosting_ZOOM_E).
...
Analyses zone par zone :

:::::::: panel-tabset
### Zone A

::: {#fig-UDMap_roosting_ZOOM_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_D.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_E.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_age_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_age_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_age_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_age_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_age_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_age_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_age_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_age_D.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone D en fonction de l'âge
:::

### Zone E

::: {#fig-UDMap_roosting_age_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_age_E.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone E en fonction de l'âge
:::
::::::::
...
::: {#fig-UDMap_roosting_sex_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_sex_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_sex_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_sex_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_sex_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_sex_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_sex_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_sex_D.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone D en fonction du sexe
:::

### Zone E

::: {#fig-UDMap_roosting_sex_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_sex_E.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone E en fonction du sexe
:::
::::::::
...
-   à partir des données de l'ensemble des individus en identifiant des zones "hotspots" [Bakker et al. (2021)](#bakker2021) et de façon global (@fig-UDMap_foraging_hotspot) sur toute la zone d'études (sur des grilles de 100m x 100m)
-   soit de façon plus fine sur les zones spécifiques A, B, C, D et E (sur des grilles de 10m x 10m, @fig-UDMap_foraging_A, @fig-UDMap_foraging_B, @fig-UDMap_foraging_C, @fig-UDMap_foraging_D, @fig-UDMap_foraging_E). Les zones d'alimentation sont identifiées à l'aide de la fonction [kernelUD]{style="font-family: 'Courier';"} du package "adehabitatHR" [Calenge (2006)](#calenge2006).
...
::: {#fig-UDMap_foraging_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_D.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_E.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_age_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_age_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_age_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_age_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_age_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_age_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_age_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_age_D.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone D en fonction de l'âge
:::

### Zone E

::: {#fig-UDMap_foraging_age_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_age_E.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone E en fonction de l'âge
:::
::::::::
...
::: {#fig-UDMap_foraging_sex_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_sex_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_sex_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_sex_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_sex_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_sex_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_sex_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_sex_D.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone D en fonction du sexe
:::

### Zone E

::: {#fig-UDMap_foraging_sex_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_sex_E.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone E en fonction du sexe
:::
::::::::
...
::: {#fig-UDMap_roosting_jour_nuit_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_jour_nuit_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_jour_nuit_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_jour_nuit_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_jour_nuit_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_jour_nuit_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_jour_nuit_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_jour_nuit_D.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone D en fonction du jour et de la nuit
:::

##### Zone E

::: {#fig-UDMap_roosting_jour_nuit_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_jour_nuit_E.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone E en fonction du jour et de la nuit
:::
::::::::
...
::: {#fig-UDMap_foraging_jour_nuit_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_jour_nuit_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_jour_nuit_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_jour_nuit_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_jour_nuit_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_jour_nuit_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_jour_nuit_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_jour_nuit_D.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_jour_nuit_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_jour_nuit_E.html",
  width = "100%",
  height = "400px"
)
```
...
Les reposoirs peuvent varier en fonction de la hauteur d'eau lors des marées hautes (@fig-UDMap_roosting_ZOOM_tides_high_type_A, @fig-UDMap_roosting_ZOOM_tides_high_type_B, @fig-UDMap_roosting_ZOOM_tides_high_type_C, @fig-UDMap_roosting_ZOOM_tides_high_type_D, @fig-UDMap_roosting_ZOOM_tides_high_type_E).
...
::: {#fig-UDMap_roosting_ZOOM_tides_high_type_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_tides_high_type_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_tides_high_type}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_tides_high_type_B.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_tides_high_type_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_tides_high_type_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_roosting_ZOOM_tides_high_type_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_tides_high_type_D.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs en fonction de la hauteur d'eau, zone D
:::

#### Zone E

::: {#fig-UDMap_roosting_ZOOM_tides_high_type_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ZOOM_tides_high_type_E.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs en fonction de la hauteur d'eau, zone E
:::
::::::::
...
::: {#fig-UDMap_roosting_ECE_wspd_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wspd_A.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone A en fonction des vents forts
:::

###### Zone B

::: {#fig-UDMap_roosting_ECE_wspd_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wspd_B.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone B en fonction des vents forts
:::

###### Zone C

::: {#fig-UDMap_roosting_ECE_wspd_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wspd_C.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone C en fonction des vents forts
:::

###### Zone D

::: {#fig-UDMap_roosting_ECE_wspd_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wspd_D.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone D en fonction des vents forts
:::

###### Zone E

::: {#fig-UDMap_roosting_ECE_wspd_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wspd_E.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone E en fonction des vents forts
:::
::::::::
...
::: {#fig-UDMap_foraging_ECE_wspd_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wspd_A.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_ECE_wspd_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wspd_C.html",
  width = "100%",
  height = "400px"
)
```
...
::: {#fig-UDMap_foraging_ECE_wspd_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wspd_D.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone D en fonction des vents forts
:::

###### Zone E

::: {#fig-UDMap_foraging_ECE_wspd_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wspd_E.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone E en fonction des vents forts
:::
::::::::

#### Vents forts de Nord-Ouest

Les vent de Nord Ouest seuls ne semblent pas avoir d'effet marqué sur le comportement des courlis. Cependant, lorsque les vents de Nord-Ouest sont particulièrement fort, cela pourrait avoir uen influence sur les comportements de repos et d'alimentation.
...
::: {#fig-UDMap_roosting_ECE_wNO_wspd95_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_wspd95_A.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone A en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone B

::: {#fig-UDMap_roosting_ECE_wNO_wspd95_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_wspd95_B.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone B en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone C

::: {#fig-UDMap_roosting_ECE_wNO_wspd95_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_wspd95_C.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone C en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone D

::: {#fig-UDMap_roosting_ECE_wNO_wspd95_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_wspd95_D.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone D en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone E

::: {#fig-UDMap_roosting_ECE_wNO_wspd95_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_roosting_ECE_wNO_wspd95_E.html",
  width = "100%",
  height = "400px"
)
```

Reposoirs zone E en fonction des vents de Nord-Ouest et des vents forts
:::
::::::::
...
::: {#fig-UDMap_foraging_ECE_wNO_wspd95_A}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wNO_wspd95_A.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone A en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone B

::: {#fig-UDMap_foraging_ECE_wNO_wspd95_B}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wNO_wspd95_B.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone B en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone C

::: {#fig-UDMap_foraging_ECE_wNO_wspd95_C}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wNO_wspd95_C.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone C en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone D

::: {#fig-UDMap_foraging_ECE_wNO_wspd95_D}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wNO_wspd95_D.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone D en fonction des vents de Nord-Ouest et des vents forts
:::

###### Zone E

::: {#fig-UDMap_foraging_ECE_wNO_wspd95_E}
```{r}
#| echo: false

tags$iframe(
  src = "UDMap_foraging_ECE_wNO_wspd95_E.html",
  width = "100%",
  height = "400px"
)
```

Alimentation zone E en fonction des vents de Nord-Ouest et des vents forts
:::
::::::::
...
Afin d'étudier l'effet de la chasse à la tonnes (point noir) et des tonnes de chasse sur l'utilisation del'espace des Courlis cendré, deux zones ont été définies (@fig-map_tonnes_v2) :
...
Tonnes de chasse (point noir), zone de proximité (jaune, 1.5km), zone de danger (rouge, 300m).
:::
...
<img src="RNN_Moëze_Oléron_-_img_48640.jpg"
     style="width: 100%; height: 200px; object-fit: cover; object-position: center; margin-bottom: 5px;" />
