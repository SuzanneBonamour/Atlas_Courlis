...
Bien que ce jeu de données soit exceptionnel de par son nombre d'individus suivis (99 individus) et la durée de ce suivi (10 ans), les analyses statistiques effectuées ici manques de puissance pour répondre avec précisions et plus de robustesse aux questions posées.

Notamment, les données sur les chasses (et la pêches) manque de précisions et d'ampleur temporelles et géopgraphies. 
