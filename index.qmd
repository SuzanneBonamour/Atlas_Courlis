...
Les domaines vitaux ("home range") individuels sont estimés à partir de tous les points (tous comportements confondus), en utilisant les fonctions [kernelUD]{style="font-family: 'Courier';"} et [getverticeshr]{style="font-family: 'Courier';"} du package "adehabitatHR" (Calenge 2006).
...
#| out.width: 30% 
#| fig-align: "center"
knitr::include_graphics("1-Reposoir limicoles Oléron-Photo RNNMO LPO.jpg", dpi = 100)
```
...
Méthode 2 : identification des hotspots (avec au moins 3 individus qui utilisent la zone) (Bakker et al. 2021)
...
::: {#fig-Chasse_au_Marais_Paris_Musées_20230829003750}
```{r}
#| echo: false
#| out.width: 50% #"50%"  # ou "300px", selon ce que tu veux
#| fig-align: "center"
knitr::include_graphics("Chasse_au_Marais_Paris_Musées_20230829003750.jpg", dpi = 100)
```
La chasse au marais. Musée Carnavalet, Histoire de Paris. (Auteurs : Beaume, Emile ou Marie Emile, Pézenas, 28–04–1888 - 1967, dessinateur-lithographe ; Langlumé, Pierre, Poitiers, 1790 - 1830, imprimeur-lithographe Anonyme, editeur.) 
:::
...
UDMap_100x100_roosting_in_out_saison_glob
:::
...
UDMap_100x100_foraging_in_out_saison_glob
:::
